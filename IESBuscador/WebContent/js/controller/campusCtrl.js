app.controller("campusCtrl",  ["$scope",  "campusService", function ($scope, campusService) {
	...
	$scope.addCampus=function(campusForm){
		campus={"id":"","location":campusForm.location,"latitude":"1.3442","longitude":"1.4253","name":campusForm.name,"city":campusForm.city,"phone":campusForm.phone,"email":campusForm.email,"id_ies":campusForm.university};
