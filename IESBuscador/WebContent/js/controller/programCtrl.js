app.controller("programCtrl",  ["$scope",  "programService", function ($scope, programService) {
	...
	$scope.addProgram=function(programForm){
		program = {"id":programForm.id,"program_name":programForm.name,"academic_level":programForm.academicLevel,"modality":programForm.modality,"credits":programForm.credits,"credit_cost":programForm.creditCost,"knowledge_area":programForm.knowledgeArea,"id_campus":programForm.camID};
		//alert(program);
		console.log(program);
